            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    <div className="flex justify-between mb-4">
                        ...
                        <span className="text-xs bg-gray-100 px-2 py-1 rounded text-gray-500 font-bold">Saldo Previsto</span>
                    </div>
                    <h3 className={`text-2xl font-extrabold mb-1 ${stats.balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>{formatCurrency(stats.balance)}</h3>
                    <p className="text-xs text-gray-400">Balanço final do mês</p>
                </div>
            </div>
